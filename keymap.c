...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_planck_mit(
        ...
        KC_TRNS, KC_MINS,   KC_EQL,   KC_LBRC,    KC_RBRC,   KC_BSLS,   KC_GRV,   KC_QUOT, KC_MPLY, KC_MNXT, RM_VALU, KC_TRNS,
    ...
    [2] = LAYOUT_planck_mit(
        ...
        KC_LSFT, S(KC_MINS),S(KC_EQL),S(KC_LBRC), S(KC_RBRC),S(KC_BSLS),S(KC_GRV),S(KC_QUOT),    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,
